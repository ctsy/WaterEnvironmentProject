...
namespace Maticsoft.DAL
{
	...
	public partial class T_UserStation
	{
		...
		public int GetMaxId()
		{
		return DbPlatFormBaseHelperSQL.GetMaxID("ID", "T_UserStation"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from T_UserStation");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.T_UserStation model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_UserStation(");
			strSql.Append("CheckTime,UserID,PointID,VerifyUser,Verify,Remark)");
			...
			parameters[0].Value = model.CheckTime;
			parameters[1].Value = model.UserID;
			parameters[2].Value = model.PointID;
			parameters[3].Value = model.VerifyUser;
			parameters[4].Value = model.Verify;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.T_UserStation model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_UserStation set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_UserStation ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.T_UserStation GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,CheckTime,UserID,PointID,VerifyUser,Verify,Remark from T_UserStation ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.T_UserStation model=new Maticsoft.Model.T_UserStation();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.T_UserStation DataRowToModel(DataRow row)
		{
			Maticsoft.Model.T_UserStation model=new Maticsoft.Model.T_UserStation();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,CheckTime,UserID,PointID,VerifyUser,Verify,Remark ");
			strSql.Append(" FROM T_UserStation ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,CheckTime,UserID,PointID,VerifyUser,Verify,Remark ");
			strSql.Append(" FROM T_UserStation ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_UserStation T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_UserStation";
