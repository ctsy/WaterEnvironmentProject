...
namespace Maticsoft.DAL
{
	...
	public partial class T_SummaryRealdata_Last
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("PointID", "T_SummaryRealdata_Last"); 
		}
		...
		public bool Exists(DateTime DataTime,int PointID,int GeneID,int DataType)
		{
			...
			strSql.Append("select count(1) from T_SummaryRealdata_Last");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_SummaryRealdata_Last(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_SummaryRealdata_Last set ");
		...
		public bool Delete(DateTime DataTime,int PointID,int GeneID,int DataType)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_SummaryRealdata_Last ");
			strSql.Append(" where DataTime=@DataTime and PointID=@PointID and GeneID=@GeneID and DataType=@DataType ");
			SqlParameter[] parameters = {
					new SqlParameter("@DataTime", SqlDbType.DateTime),
					new SqlParameter("@PointID", SqlDbType.Int,4),
		...
		public Maticsoft.Model.T_SummaryRealdata_Last GetModel(DateTime DataTime,int PointID,int GeneID,int DataType)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 DataTime,PointID,GeneID,DataType,StateValue,DataValue,DataMaxValue,DataMinValue,DataCouValue,ConvertValue,ConvertMaxValue,ConvertMinValue,WriteTime,DevCode,Person,AuditTime,AbnormalLedger from T_SummaryRealdata_Last ");
			strSql.Append(" where DataTime=@DataTime and PointID=@PointID and GeneID=@GeneID and DataType=@DataType ");
			SqlParameter[] parameters = {
					new SqlParameter("@DataTime", SqlDbType.DateTime),
					new SqlParameter("@PointID", SqlDbType.Int,4),
			...
			Maticsoft.Model.T_SummaryRealdata_Last model=new Maticsoft.Model.T_SummaryRealdata_Last();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.T_SummaryRealdata_Last DataRowToModel(DataRow row)
		{
			Maticsoft.Model.T_SummaryRealdata_Last model=new Maticsoft.Model.T_SummaryRealdata_Last();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM T_SummaryRealdata_Last ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_SummaryRealdata_Last T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_SummaryRealdata_Last";
