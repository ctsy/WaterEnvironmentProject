...
namespace Maticsoft.DAL
{
	...
	public partial class T_WarningNotice
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "T_WarningNotice"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from T_WarningNotice");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_WarningNotice ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
			parameters[0].Value = Id;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,PointID,Telephone,Mail ");
			strSql.Append(" FROM T_WarningNotice ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_WarningNotice T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_WarningNotice";
